...
>
> **Note (2026-08-04): the entire MinGW/MSYS2 toolchain path described in this guide is OBSOLETE.** V1.5 actually shipped via **MSVC 2022 + vcpkg** on Windows and **`makefile.unix`** on Linux — see `Blazecoin_V1.5_Technical_Changelog.md` §11 ("Build environment") for the authoritative build recipe.
